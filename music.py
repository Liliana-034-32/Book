...
import re
#from new_design import actionClicked
...
class QCustomQWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.edit_button.setIcon(QtGui.QIcon('edit_muz - копия.png'))
        ...
        self.delete_button.setIcon(QtGui.QIcon('delete_muz.png'))
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        cursor.execute('''CREATE TABLE IF NOT EXISTS music(
           ...
           ''')
        con.commit()
        label = QtWidgets.QLabel('Meow', self)
        tool_bar = self.addToolBar('Панель инструментов')
        menu_bar = self.menuBar()
        file_menu = menu_bar.addMenu('Главное меню')

        addAction = QtWidgets.QAction(QtGui.QIcon('add_muz.png'), 'Добавить музыку', self)
        ...
        self.setWindowIcon(QtGui.QIcon('icon_muz.png'))
...
class Dialog(QtWidgets.QDialog):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowIcon(QtGui.QIcon('editm.png'))
