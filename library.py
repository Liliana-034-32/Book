...
class QCustomQWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.edit_button.setToolTip('Редактировать книгу')
        ...
        self.delete_button.setToolTip('Удалить книгу')
        ...
        self.web_button.setToolTip('Читать книгу онлайн')
    ...
    def web(self):
        ...
        self.view.setWindowIcon(QtGui.QIcon("web.png"))
        self.view.setWindowTitle('Читать книгу онлайн')
        self.view.show()
